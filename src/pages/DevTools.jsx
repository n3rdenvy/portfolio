...
const NT_MOTIONS = [
  {
    gif:     '/devtools/nt_motions/pulse_compact.gif?v=4',
    label:   'Pulse',
  ...
  {
    gif:     '/devtools/nt_motions/hum_compact.gif?v=4',
    label:   'Engine Hum',
    desc:    'Needle jitters like an analog gauge under load. Signals active compute.',
    service: 'OpenAI', pct: 92, used: '920k', total: '1M', burn: '9.2k', days: 2,
    bar_hex: '#4AB8FF',
  },
  {
    gif:     '/devtools/nt_motions/sweep_compact.gif?v=4',
    label:   'Radar Sweep',
    desc:    'Ghost segments scan across the filled arc. Feels like live polling.',
    service: 'Cursor', pct: 27, used: '135k', total: '500k', burn: '8.4k', days: 17,
    bar_hex: '#F58220',
  },
  {
    gif:     '/devtools/nt_motions/drift_compact.gif?v=4',
    label:   'Live Drift',
  ...
  {
    gif:     '/devtools/nt_motions/charge_compact.gif?v=4',
    label:   'Charge Cycle',
    desc:    'Ring expands from center and fades. Reads like charging or refreshing.',
    service: 'Mistral', pct: 44, used: '44', total: '100 prompts', burn: '3.1k', days: 38,
    bar_hex: '#818CF8',
  },
];

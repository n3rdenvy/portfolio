  ...
  return (
    <PageShell width="narrow">
      ...
      <article className="glass rounded-2xl p-8 md:p-12">
        <h1 className="text-3xl font-semibold tracking-tight text-accent md:text-4xl">National ROI Framework</h1>
        <p className="mt-4 text-lg leading-relaxed text-textPrimary md:text-xl">
          Unifying 4 siloed teams and 7 technical tools into a single national media standard
        </p>
        <div className="mt-10 space-y-6 text-[15px] leading-[1.75] text-textSecondary md:text-base">
          <p>
